<?php
/**
 * Plugin Name: Quick Order/Subscription Edit
 * Plugin URI: https://github.com/shirgans/quick-order-edit
 * Description: A simple widget that allows you to quickly access and edit orders/subscriptions from the top admin bar
 * Version: 1.0
 * Author: Shir Gans
...
add_action( 'admin_bar_menu', 'add_quick_order_edit_to_admin_bar', 100 );

function add_quick_order_edit_to_admin_bar( $wp_admin_bar ) {
    $args = array(
        'id'     => 'quick_order_edit',
        ...
        'meta'   => array( 'class' => 'quick_order_edit' )
    );
